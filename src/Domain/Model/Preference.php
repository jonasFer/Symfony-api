...
/**
 * @ORM\Entity(repositoryClass="App\Infrastructure\Repository\PreferenceRepository")
 */
class Preference
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Domain\Model\TaskList", inversedBy="preferences")
     */
    private $list;
